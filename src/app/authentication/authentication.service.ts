...
export class AuthenticationService {
    ...
    public getToken(): Observable<any> {
         ...
         * Internal user
         */
        /* tslint:disable */ return Observable.of(`eyJ0eXAiOiJqd3QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX3V1aWQiOiJCUkVTIiwicm9sZSI6ImludGVybmFsIn0.TeamX2lWfucai40rfI2FeGmKPkwnrsn2YrcEaCGPK-A`);
